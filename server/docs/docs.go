...
const docTemplate = `{
    ...
    "paths": {
                                                ...
                                                },
                                                {
                                                    ...
                                                    "properties": {
                                                        "list": {
                                                            "type": "array",
                                                            "items": {
                                                                "$ref": "#/definitions/response.ReturnValue"
                                                            }
                                                        }
                                                    }
                                                }
        ...
        "/api/house/landlordContactView/action": {
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.LandlordContactViewAction"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/house/landlordContactView/list": {
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.LandlordContactViewSearch"
                        }
                    }
                ],
                "responses": {
                                                ...
                                                },
                                                {
                                                    ...
                                                    "properties": {
                                                        "list": {
                                                            "type": "array",
                                                            "items": {
                                                                "$ref": "#/definitions/response.LandlordContactViewResponse"
                                                            }
                                                        }
                                                    }
                                                }
        ...
        "/api/xiaoqu/dict/delete": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "楼盘字典删除参数",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.XiaoQuDictDeleteRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "删除后的楼盘字典树",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.XiaoQuDictTreeResponse"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
        ...
        "/api/xiaoqu/dict/upsert": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "楼盘字典新增/修改参数",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.XiaoQuDictUpsertRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "保存后的楼盘字典树",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SearchXiaoqu"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "分页列表,返回包括列表,总数,页码,每页数量",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/center/house/share/list": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "分享token、小区ID和筛选条件",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ResourceShareListSearch"
                        }
                    }
                ],
                "responses": {
        ...
        "/center/house/share/map": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "分享token和筛选条件",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ResourceShareSearch"
                        }
                    }
                ],
                "responses": {
                                                ...
                                                },
                                                {
                                                    ...
                                                    "properties": {
                                                        "list": {
                                                            "type": "array",
                                                            "items": {
                                                                "$ref": "#/definitions/response.RewardApplicationResponse"
                                                            }
                                                        }
                                                    }
                                                }
        ...
        "/wx/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "手机号，短信验证码, 临时登陆凭证code",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "request.GetUserList": {
            ...
            "properties": {
                ...
                "isFindHouseSupermarket": {
                    "description": "找房超市标识 1有 2没有 0不筛选",
                    "type": "integer"
                },
                "isPublish": {
                    "description": "上架权限 1有 2没有 0不筛选",
                    "type": "integer"
                },
                "keyword": {
                    "description": "关键字",
        ...
        "request.LandlordContactViewAction": {
            "type": "object",
            "properties": {
                "action": {
                    "description": "操作类型 pending  processing approved paid rejected   待审核 审核中 已通过，未付款 已付款 未通过，已拒绝",
                    "type": "string"
                },
                "id": {
                    "description": "记录ID",
        ...
        "request.LandlordContactViewSearch": {
            "type": "object",
            "properties": {
                "keyword": {
                    "description": "关键字",
        ...
        "request.ResourceShareListSearch": {
            "type": "object",
            "properties": {
                "feature": {
                    "description": "有无电梯",
        ...
        "request.SearchNameResource": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "房源状态：待出租、已下架",
                    "type": "string"
                },
                "updatedAtLast": {
                    "description": "最后编辑时间结束",
                    "type": "string"
                },
                "updatedAtStart": {
                    "description": "最后编辑时间开始",
                    "type": "string"
                },
                "xiaoquId": {
                    "description": "小区ID",
        ...
        "request.XiaoQuDictBuildingOp": {
            "type": "object",
            "properties": {
                "buildingOpenId": {
                    "description": "楼栋OpenID（新增可选）",
                    "type": "string"
                },
                "id": {
                    "description": "楼栋记录ID（更新必填）",
                    "type": "integer"
                },
                "name": {
                    "description": "楼栋名称（必填）",
        ...
        "request.XiaoQuDictDeleteRequest": {
            "type": "object",
            "properties": {
                "buildingIds": {
                    "description": "要删除的楼栋ID列表",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
        ...
        "request.XiaoQuDictHouseOp": {
            "type": "object",
            "properties": {
                "houseOpenId": {
                    "description": "房号OpenID（新增可选）",
                    "type": "string"
                },
                "id": {
                    "description": "房号记录ID（更新必填）",
                    "type": "integer"
                },
                "name": {
                    "description": "房号名称（必填）",
                ...
                "unitOpenId": {
                    "description": "所属单元OpenID（新增必填）",
                    "type": "string"
                }
            }
        },
        "request.XiaoQuDictUnitOp": {
            "type": "object",
            "properties": {
                "buildingOpenId": {
                    "description": "所属楼栋OpenID（新增必填）",
                    "type": "string"
                },
                "id": {
                    "description": "单元记录ID（更新必填）",
                    "type": "integer"
                },
                "name": {
                    "description": "单元名称（必填）",
                ...
                "unitOpenId": {
                    "description": "单元OpenID（新增可选）",
                    "type": "string"
                }
            }
        },
        "request.XiaoQuDictUpsertRequest": {
            "type": "object",
            "properties": {
                "buildingOps": {
                    "description": "楼栋新增/修改列表",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.XiaoQuDictBuildingOp"
                    }
                },
                "houseOps": {
                    "description": "房号新增/修改列表",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.XiaoQuDictHouseOp"
                    }
                },
                "unitOps": {
                    "description": "单元新增/修改列表",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.XiaoQuDictUnitOp"
                    }
                },
                "xiaoquId": {
                    "description": "小区ID",
        ...
        "response.LandlordContactViewResponse": {
            "type": "object",
            "properties": {
                "doorNo": {
                    "description": "门牌号",
        ...
        "response.RewardApplicationResponse": {
            "type": "object",
            "properties": {
                "ID": {
                    "description": "主键ID",
                ...
                "applyUserPhone": {
                    "description": "下面这些联系人信息是申请创建时的快照，\n避免用户后续修改手机号/微信号后，历史审核单展示被“穿透更新”。",
                    "type": "string"
                },
                "applyUserWxNickName": {
                    "description": "申请人微信昵称",
                ...
                "lastOperatedAtUnixMilli": {
                    "description": "最后操作时间毫秒",
                    "type": "integer"
                },
                "publisherConfirmStatus": {
                    "description": "发布人确认状态",
                ...
                "publisherUserPhone": {
                    "description": "发布人手机号快照",
                    "type": "string"
                },
                "publisherUserWxNo": {
                    "description": "发布人微信号快照",
                    "type": "string"
                },
                "publisherWxNickName": {
                    "description": "发布人微信昵称",
        ...
        "response.XiaoQuDictBuildingNode": {
            "type": "object",
            "properties": {
                "buildingOpenId": {
                    "description": "楼栋OpenID",
                    "type": "string"
                },
                "id": {
                    "description": "楼栋记录ID",
                ...
                "units": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.XiaoQuDictUnitNode"
                    }
                }
            }
        },
        "response.XiaoQuDictHouseNode": {
            "type": "object",
            "properties": {
                "houseOpenId": {
                    "description": "房号OpenID",
                    "type": "string"
                },
                "id": {
                    "description": "房号记录ID",
        ...
        "response.XiaoQuDictTreeResponse": {
            "type": "object",
            "properties": {
                "buildings": {
                    "description": "楼栋树",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.XiaoQuDictBuildingNode"
                    }
                },
                "communityId": {
                    "description": "社区ID",
        ...
        "response.XiaoQuDictUnitNode": {
            ...
            "properties": {
                "houses": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.XiaoQuDictHouseNode"
                    }
                },
                "id": {
                    "description": "单元记录ID",
