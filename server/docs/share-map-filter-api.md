...
```json
{
  ...
  "data": {
    "rentType": [
      {"name": "整租", "houseType": ["1居", "2居", "3居", "4居+", "开间"], "feature": ["可短租", "包物业", "有电梯", "密码看房", "可办公注册"]},
      {"name": "分整租", "houseType": ["1居", "2居", "3居", "4居+"], "feature": ["带阳台", "有电梯", "有原卫", "朝南", "有燃气", "可短租"]},
      {"name": "合租", "houseType": ["2居", "3居", "4居+"], "feature": ["带阳台", "可短租", "有电梯", "有独卫", "可做饭", "纯女生"]}
    ],
    "price": {
