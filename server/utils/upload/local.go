...
func (*Local) UploadFile(file *multipart.FileHeader) (string, string, error) {
	...
	if createErr != nil {
		global.GVA_LOG.Error("function os.CreateOrUpdate() failed", zap.Any("err", createErr.Error()))

		return "", "", errors.New("function os.CreateOrUpdate() failed, err:" + createErr.Error())
	}
