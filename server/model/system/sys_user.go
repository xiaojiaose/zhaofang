...
type SysUser struct {
	...
	IsFindHouseSupermarket bool `json:"isFindHouseSupermarket" gorm:"default:false;comment:找房超市标识"`
	// 上架额度限制的是“同时处于待出租状态的房源数量”。
	IsPublish         bool `json:"isPublish"  gorm:"default:false;comment:上架权限"`
	PublishQuotaTotal int  `json:"publishQuotaTotal" gorm:"default:0;comment:可上架房源总数"`
	// 该次数用于房东房源联系方式查看扣减。
