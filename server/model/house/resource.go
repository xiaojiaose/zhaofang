...
type Resource struct {
	...
	BuildingId      string               `json:"building_id,omitempty"`        // 楼栋ID
	UnitId          string               `json:"unit_id,omitempty"`            // 单元ID
	HouseId         string               `json:"house_id,omitempty"`           // 房号ID
	...
	IsTeamHouse     bool                 `json:"is_team_house"`                // 是否团队房源
	Owner           uint                 `json:"owner"`                        // 房源归属用户ID
