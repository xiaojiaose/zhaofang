          ...
          <div>
            ...
            <el-tabs v-model="activeName" @tab-click="handleClick">
              ...
              <!-- <el-tab-pane label="验证码登录" name="mobile">
                ...
                >
                  <el-form-item prop="mobile" class="mb-6">
                    <el-input
                  ...
                  <el-form-item prop="sms" class="mb-6">
                    <div class="flex w-full justify-between">
                      <el-input
...
<script setup>
import { captcha, sendPhoneCode } from "@/api/user";
...
const phoneLogin = async () => {
  return await userStore.phoneLoginIn(phoneForm);
}
...
const handlePhoneLogin = () => {
  phoneRef.value.validate(async (v) => {
    if (!v) {
      // 未通过前端静态验证
      ElMessage({
        type: "error",
