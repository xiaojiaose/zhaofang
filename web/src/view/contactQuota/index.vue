    ...
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo">
        <el-form-item label="经纪人电话">
          <el-input v-model="searchInfo.userPhone" clearable placeholder="请输入经纪人电话" />
        </el-form-item>
        <el-form-item>
      ...
      <el-form :inline="true" :model="form">
        <el-form-item label="经纪人电话">
          <el-input v-model="form.userPhone" clearable placeholder="请输入经纪人电话" />
        </el-form-item>
        <el-form-item label="增加次数">
          <el-input-number v-model="form.amount" :min="1" placeholder="请输入增加次数" />
        </el-form-item>
